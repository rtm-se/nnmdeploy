...
genre_seeds = ["acoustic","afrobeat","alt-rock","alternative","ambient","anime","black-metal","bluegrass","blues",
...
genres = ['brighton indie', 'chamber psych', 'egg punk', 'english indie rock', 'indie rock',
          'modern alternative rock', 'uk post-punk revival']
results = []
for genre in genres:
    ...
    if semi_result:
        ...
        if semi_result:
            results.append(semi_result[0])
genre_strings = ','.join(set(results))
print(genre_strings)
